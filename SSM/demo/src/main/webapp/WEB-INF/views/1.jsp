                ...
                <div class="col-sm-3">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <p class="lead">Hoole Statistic</p>
                    ...
                    <form role="form" class="form-horizontal">
                        ...
                        <div style="padding:14px;" class="form-group">
                            <textarea placeholder="想说点什么..." rows="5" class="form-update"></textarea>
                        </div>
                ...
                <div class="col-sm-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="vendor">
                            ...
                            <!--
                            <iframe width="100%" height="315" src="${pageContext.request.contextPath}/assets/video/cardshow.mp4" frameborder="0" allowfullscreen=""></iframe>
                            -->
                        </div>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="vendor">
                            ...
                            <a class="fancybox" rel="group" href="#">
                                <img class="img-responsive-media" src="assets/img/people-q-c-350-250-7.jpg" alt="">
                            </a>
                        </div>
                        <div class="video-text">
                            <h2>Black Angel</h2>
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="vendor">
                            ...
                            <!--
                            <iframe width="100%" height="166" scrolling="no" frameborder="no" src="${pageContext.request.contextPath}/assets/music/123.mp3"></iframe>
                            ...
                            <div class="vendor">
                                <div data-ride="carousel" class="carousel slide" id="carousel-example-generic">
                                    ...
                                    <div class="carousel-inner">
                                        <div class="item">
                                            <img class="img-responsive-media" alt="First slide" src="assets/img/people-q-c-350-250-5.jpg">
                                        </div>
                                        <div class="item active">
                                            <img class="img-responsive-media" alt="Second slide" src="assets/img/people-q-c-350-250-7.jpg">
                                        </div>
                                        <div class="item">
                                            <img class="img-responsive-media" alt="Third slide" src="assets/img/people-q-c-350-250-8.jpg">
                                        </div>
                                    </div>
